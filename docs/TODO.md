...
[*] Sjednotit UI vizuálně s explorer projekty přes lokální Tabler shell a embedded assets.
[*] Přidat základní Justfile joby build, build-linux a build-win.
[*] Odstranit duplicitní akční tlačítka Details a Metrics z UI headeru.
